...
<!--<ul class="share-list">-->
<!--    <li class="share-item">-->
<!--        <a href="https://www.facebook.com/sharer.php?display=page&u=--><?php //the_permalink(); ?><!--&t=--><?php //the_title(); ?><!--" class="share-link share-link--facebook" rel="nofollow" target="_blank">-->
